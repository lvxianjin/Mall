...
<head>
    ...
    <link href="<%=basePath%>/css/search-result.css" type="text/css" rel="stylesheet"/>
...
<div class="body-ctn">
    ...
    <div class="main-ctn">
        ...
        <section class="phone-area" id="phone-ctn">
            <h2 class="area-title">搜索结果</h2>
            <div class="items-area">
                <!-- 插入数据 -->
                <c:forEach items="${phoneListByTitle}" var="phone">
                ...
                <c:forEach items="${notebookListByTitle}" var="notebook">
                    <div class="items-block">
                ...
                <c:forEach items="${tvListByTitle}" var="tv">
                    <div class="items-block">
                ...
                <c:forEach items="${partListByTitle}" var="part">
                    <div class="items-block">
